    ...
    >
      ...
      >
        ...
        <p style={{ opacity: 0.7, fontWeight: 600 }}>
          Share the code or QR to let players join
        </p>
      </div>
      ...
      >
        {/* Room code + QR */}
        <div
          className="card animate-fadeInDown delay-1"
          style={{ textAlign: "center" }}
        >
          <p style={{ opacity: 0.7, fontWeight: 700, marginBottom: "0.5rem" }}>
            Room Code
          </p>
          <div
            style={{
        ...
        {/* Player list */}
        <div
          className="card animate-fadeInDown delay-2"
